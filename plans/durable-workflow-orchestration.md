...
Last updated: 2026-05-05. Reflects Phase 0 complete and Phase 0.5 in progress on fork `littlething666/abyss-engine`. PRs are stacked: each step's PR targets the previous step's branch as its base.
