...
export const JSON_SCHEMA_RESPONSE_FORMAT_NAMES: Record<ArtifactKind, string> = {
  ...
  'topic-card-content': 'topic_card_content',
  'topic-mini-game-content': 'topic_mini_game_content',
...
const SCHEMA_BY_KIND: Record<ArtifactKind, { toJSONSchema(): Record<string, unknown> }> = {
  ...
  'topic-card-content': topicCardContentArtifactSchema,
  'topic-mini-game-content': topicMiniGameContentArtifactSchema,
...
> = {
  ...
  'topic-card-content': jsonSchemaResponseFormat('topic-card-content'),
  'topic-mini-game-content': jsonSchemaResponseFormat('topic-mini-game-content'),
