...
const baseProps: StudyPanelStateViewsProps = {
  ...
  agentPersonality: 'Expert lecturer',
  agentPersonalityOptions: ['Expert lecturer'],
  resolvedTopic: 'Mathematics',
  onClose: vi.fn(),
  onSetTargetAudience: vi.fn(),
  onSetAgentPersonality: vi.fn(),
  openAiCompatibleModelId: '',
  openAiCompatibleModelOptions: [''],
  onSetOpenAiCompatibleModelId: vi.fn(),
  openAiCompatibleChatUrl: '',
  onSetOpenAiCompatibleChatUrl: vi.fn(),
  openAiCompatibleApiKey: '',
  onSetOpenAiCompatibleApiKey: vi.fn(),
