    ...
    case 'CATEGORY_SORT':
      return fill(
        [
          ...
          '    ],',
          '    "items": [',
          '      { "id": "it-1", "label": "Item one", "categoryId": "cat-a" },',
          '      { "id": "it-2", "label": "Item two", "categoryId": "cat-a" },',
          '      { "id": "it-3", "label": "Item three", "categoryId": "cat-b" },',
          '      { "id": "it-4", "label": "Item four", "categoryId": "cat-b" },',
          '      { "id": "it-5", "label": "Item five", "categoryId": "cat-c" },',
          '      { "id": "it-6", "label": "Item six", "categoryId": "cat-c" }',
          '    ]',
          '  }',
          '}',
          '```',
